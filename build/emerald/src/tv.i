...
void ChangePokemonNickname(void)
{
    ...
    DoNamingScreen(NAMING_SCREEN_NICKNAME, gStringVar2, GetMonData(&gPlayerParty[gSpecialVar_0x8004], 11, ((void *)0)), GetMonGender(&gPlayerParty[gSpecialVar_0x8004]), GetMonData(&gPlayerParty[gSpecialVar_0x8004], 0, ((void *)0)), ChangePokemonNickname_CB);
}
...
void ChangeBoxPokemonNickname(void)
{
    ...
    DoNamingScreen(NAMING_SCREEN_NICKNAME, gStringVar2, GetBoxMonData(boxMon, 11, ((void *)0)), GetBoxMonGender(boxMon), GetBoxMonData(boxMon, 0, ((void *)0)), ChangeBoxPokemonNickname_CB);
}
