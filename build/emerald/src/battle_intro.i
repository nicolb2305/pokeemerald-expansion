...
void sub_8118FBC(int bgId, u8 arg1, u8 arg2, u8 battlerPosition, u8 arg4, u8 *arg5, u16 *arg6, u16 tilesOffset)
{
    ...
    CpuSet(gMonSpritesGfxPtr->sprites.ptr[battlerPosition] + 0x800 * gBattleMonForms[battler], arg5, 0x00000000 | ((0x800)/(16/8) & 0x1FFFFF));
...
void unref_sub_8119094(u8 arg0, u8 arg1, u8 battlerPosition, u8 arg3, u8 arg4, u16 arg5, u8 arg6, u8 arg7)
{
    ...
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(gMonSpritesGfxPtr->sprites.ptr[battlerPosition] + 0x800 * arg3); dmaRegs[1] = (vu32)((void *)(0x6000000 + (0x800 * (0))) + arg5); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x800)/(16/8))); dmaRegs[2]; };
