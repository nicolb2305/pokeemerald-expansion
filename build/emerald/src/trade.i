...
static u8 CheckValidityOfTradeMons(u8 *aliveMons, u8 playerPartyCount, u8 playerMonIdx, u8 partnerMonIdx)
{
    ...
    if (partnerSpecies == 386 || partnerSpecies == 151)
    {
...
static u32 CanTradeSelectedMon(struct Pokemon *playerParty, int partyCount, int monIdx)
{
    ...
    if (species[monIdx] == 386 || species[monIdx] == 151)
    {
...
int GetUnionRoomTradeMessageId(struct GFtgtGnameSub rfuPlayer, struct GFtgtGnameSub rfuPartner, u16 playerSpecies2, u16 partnerSpecies, u8 requestedType, u16 playerSpecies, u8 isObedientBitSet)
{
    ...
    if (playerSpecies2 == 898 + 308 + 1 && playerSpecies2 != partnerSpecies)
    {
        return 3;
    }
...
static bool8 AnimateTradeSequenceCable(void)
{
    ...
    case 10:
        ...
        if (sTradeData->monSpecies[0] != 898 + 308 + 1)
        {
    ...
    case 65:
        ...
        {
            HandleLoadSpecialPokePic_2(&gMonFrontPicTable[sTradeData->monSpecies[1]], gMonSpritesGfxPtr->sprites.ptr[3], sTradeData->monSpecies[1], sTradeData->monPersonalities[1]);
            sTradeData->state++;
        }
        break;
    case 66:
    ...
    case 72:
        ...
        evoTarget = GetEvolutionTargetSpecies(&gPlayerParty[gSelectedTradeMonPositions[0]], 1, 0, GetMonData(&gPlayerParty[gSelectedTradeMonPositions[1]], 11));
        if (evoTarget != 0)
        {
