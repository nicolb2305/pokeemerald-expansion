...
static void CreateLilycoveSSTidalMultichoice(void)
{
    ...
    if (CheckBagHasItem(470, 1) == 1 && FlagGet((((0x500 + 864 - 1) + 1) + 0x53)) == 1)
    {
        if (gSpecialVar_0x8004 == 0)
        {
    ...
    if (CheckBagHasItem(559, 1) == 1 && FlagGet((((0x500 + 864 - 1) + 1) + 0x80)) == 1)
    {
        if (gSpecialVar_0x8004 == 0)
        {
    ...
    if (CheckBagHasItem(560, 1) == 1 && FlagGet((((0x500 + 864 - 1) + 1) + 0x75)) == 1)
    {
        if (gSpecialVar_0x8004 == 0)
        {
    ...
    if (CheckBagHasItem(565, 1) == 1 && FlagGet((((0x500 + 864 - 1) + 1) + 0x76)) == 1)
    {
        if (gSpecialVar_0x8004 == 0)
        {
