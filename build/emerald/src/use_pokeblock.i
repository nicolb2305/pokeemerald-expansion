...
# 27 "src/use_pokeblock.c" 2
# 36 "src/use_pokeblock.c"
enum {
    WIN_NAME,
    WIN_NATURE,
    WIN_TEXT,
...
static void UpdateMonPic(u8 loadId)
{
    ...
    {
        { const void *_src = sMenu->partySheets[loadId]; void *_dest = sMenu->curMonTileStart; u32 _size = 0x800; while (1) { if (_size <= 0x1000) { { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; break; } { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x1000)/(16/8))); dmaRegs[2]; }; _src += 0x1000; _dest += 0x1000; _size -= 0x1000; } };
