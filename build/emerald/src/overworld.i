...
static bool8 FacingHandler_DpadMovement(struct LinkPlayerObjectEvent *linkPlayerObjEvent, struct ObjectEvent *objEvent, u8 a3)
{
    ...
    ((u8*)objEvent)[((size_t)&((typeof(*objEvent) *)0)->fieldEffectSpriteId) - 1] = FlipVerticalAndClearForced(a3, ((u8*)objEvent)[((size_t)&((typeof(*objEvent) *)0)->fieldEffectSpriteId) - 1]);
