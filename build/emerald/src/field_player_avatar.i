...
static void PlayerNotOnBikeMoving(u8 direction, u16 heldKeys)
{
    ...
    if (!(gPlayerAvatar.flags & (1 << 4)) && (heldKeys & 0x0002) && FlagGet((((0x500 + 864 - 1) + 1) + 0x60))
...
# 1686 "src/field_player_avatar.c"
...
static bool8 Fishing_GetRodOut(struct Task *task)
{
    ...
    task->data[12] = 0;
    task->data[13] = minRounds1[task->data[15]] + (Random() % minRounds2[task->data[15]]);
