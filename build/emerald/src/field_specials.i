...
{
    u16 monData;
    CreateMon(&gPlayerParty[0], 263, 7, 32, 0, 0, 0, 0);
    monData = 1;
...
{
    if (gSpecialVar_0x8004 >= 482 && gSpecialVar_0x8004 <= 539)
    {
