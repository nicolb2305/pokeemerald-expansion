...
const u8 gText_DefaultNameAllie[] = _("Aallie");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose Pokémon or canel.");
...
const u8 gText_Cushion[] = _("Cusion");
...
const u8 gText_NormalRank[] = _("Nomal Rank");
...
const u8 gText_EnergyPowder50[] = _("Energyoowder{CLEAR_TO 0x72}{SIZE 0}50");
...
const u8 gText_LilycoveCity[] = _("Lilicove City");
...
const u8 gPCText_Savanna[] = _("Svanna");
...
const u8 gText_Carbos1BP[] = _("Carboc{CLEAR_TO 0x64}1BP");
